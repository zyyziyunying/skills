...
description: Use when creating, reviewing, or fixing Flutter UI that must adapt to available space, screen/window size, orientation, fixed Figma/CSS dimensions, first-screen visibility, overflow risk, image/card/dialog sizing, portrait/landscape layouts, or mobile/tablet/desktop/frame form factors. Prefer LayoutBuilder, MediaQuery.sizeOf, constraints, Expanded/Flexible, bounded scrollables, maxWidth/maxHeight, and adaptive breakpoints.
metadata:
  model: models/gemini-3.1-pro-preview
  last_modified: Tue, 16 Jun 2026 05:22:49 GMT
---
